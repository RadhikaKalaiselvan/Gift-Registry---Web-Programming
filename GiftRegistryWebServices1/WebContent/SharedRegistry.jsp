...
<div class="container">
   <div class="row">
		<div class="col">
		<h2 class="form-signin-heading">Shared Registry</h2>
		</div>
...
<% List<Registry> reg = (List<Registry>) request.getAttribute("mySharedRegistries");%><br>

<% for(Registry rg:reg) { %>
<div class="container">
 <fieldset>
<div class="control-group">
<form action="ProductsofSharedRegistry" method="get">
...
<label class="control-label"  for="username">Shared User ID :</label>
<div class="controls">
<input type="Text"  name="sharedUserid"value="<%=rg.getUserID() %>" readonly><br>
</div>

	<input style="margin-top:8px" class="btn btn-primary" type="submit" value="OPEN">
</form>
</div>
</fieldset>
</div>
